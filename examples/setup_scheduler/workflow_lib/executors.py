    ...
    def __init__(self, name: str):
        config = Config({
            "executors.account1_executor": {
                "image": f"YOUR_ACCOUNT1_ID.dkr.ecr.us-west-2.amazonaws.com/redun_aws_batch_example",
    ...
    def __init__(self, name: str):
        config = Config({
            "executors.account2_executor": {
                "image": f"YOUR_ACCOUNT2_ID.dkr.ecr.us-west-2.amazonaws.com/redun_aws_batch_example",
