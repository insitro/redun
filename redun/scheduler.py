...
def _subrun_root_task(
    ...
    if not new_execution:
        ...
        # Build fresh expressions for the sub-scheduler. This will avoid book-keeping
        # (e.g. TaskExpression.call_hash) from being shared with parent scheduler, which
        # can cause issues with provenance recording.
        expr_eval = pickle_loads(pickle_dumps(expr_eval))
